    ...
    <section>
        <div id="no-print">
            ...
            <header>
                ...
                <button @click="clearPage()" class="fr show-print__btn">清空页面</button>
                <button @click="showPrint()" class="fr show-print__btn mgr5">打印预览</button>
            </header>
            <!--头部-->
            ...
            <!--内容主题-->
            <section class="content" ref="J-print-content">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            showPrint () {
                var that = this;
                var print = that.$refs['J-print'];
                var content = that.$refs['J-print-content'];
